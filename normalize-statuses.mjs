...
function normalizeStatus(raw) {
  const normalized = normalizeStatusMeta(raw, CAREER_OPS);
  if (!normalized.recognized) return { status: null, unknown: true };
  return { status: normalized.label, moveToNotes: normalized.moveToNotes };
}
